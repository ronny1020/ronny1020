...
<p align="center">
  <sub><b>385,399</b> npm installs in the last year · <b>7</b> pull requests merged into projects with <b>145,405</b> stars between them · <b>484</b> commits maintaining a community docs site · <b>46</b> stars on my own repositories · on GitHub since <b>2019</b></sub>
</p>
...
- **[TanStack/query](https://github.com/TanStack/query)** ⭐&nbsp;50,296<br> [docs(query-react): Update links in useQuery documentation](https://github.com/TanStack/query/pull/11006) <sub>merged Aug&nbsp;17,&nbsp;2026</sub>
...
- **[pixijs/pixijs](https://github.com/pixijs/pixijs)** ⭐&nbsp;48,157<br> [fix(application): prevent reading property of null if the application is destroyed](https://github.com/pixijs/pixijs/pull/9514) <sub>merged Jul&nbsp;6,&nbsp;2023</sub>
...
| ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- |
| [**muster**](https://github.com/ronny1020/muster)<br><sub>TypeScript · pushed Sep&nbsp;14,&nbsp;2026</sub>               | Run AI agent CLIs in tabs, each a real terminal with its own directory and git state   |
...
<p align="center">
  <sub>Taipei · README rebuilt from the GitHub API — last run Sep 15, 2026, 4:09 AM GMT+8</sub>
</p>
